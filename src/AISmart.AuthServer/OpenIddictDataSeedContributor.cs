...
//     {
//         await _scopeManager.CreateAsync(await GetOpenIddictScopeModelAsync(_testData.Scope1Id,
...
//             }));
//
//         await _scopeManager.CreateAsync(await GetOpenIddictScopeModelAsync(_testData.Scope2Id,
//             new OpenIddictScopeDescriptor()
//             {
...
//     }
//
//     private async Task<OpenIddictScopeModel> GetOpenIddictScopeModelAsync(Guid id,
//         OpenIddictScopeDescriptor scopeDescriptor)
//     {
...
//             ClientUri = "https://localhost:44376/",
//             // ClientSecret = "1q2w3e*",
//             RedirectUris =
//             {
...
//         }
//
//         var applicationTemp = await GetOpenIddictApplicationModelAsync(_testData.App1Id, application);
//         
//         await _applicationManager.CreateAsync(applicationTemp);
//
//         await _applicationManager.CreateAsync(await GetOpenIddictApplicationModelAsync(_testData.App2Id,
...
//     {
//         await _tokenManager.CreateAsync(await GetOpenIddictTokenModelAsync(_testData.Token1Id,
...
//             }));
//
//         await _tokenManager.CreateAsync(await GetOpenIddictTokenModelAsync(_testData.Token2Id,
//             new OpenIddictTokenDescriptor
//             {
...
//     }
//
//     private async Task<OpenIddictTokenModel> GetOpenIddictTokenModelAsync(Guid id,
//         OpenIddictTokenDescriptor tokenDescriptor)
//     {
...
//     {
//         await _authorizationManager.CreateAsync(await GetOpenIddictAuthorizationModelAsync(_testData.Authorization1Id,
...
//             }));
//
//         await _authorizationManager.CreateAsync(await GetOpenIddictAuthorizationModelAsync(_testData.Authorization2Id,
//             new OpenIddictAuthorizationDescriptor
//             {
//                 ApplicationId = _testData.App2Id.ToString(),
...
//     }
//
//     private async Task<OpenIddictAuthorizationModel> GetOpenIddictAuthorizationModelAsync(Guid id,
//         OpenIddictAuthorizationDescriptor authorizationDescriptor)
//     {
