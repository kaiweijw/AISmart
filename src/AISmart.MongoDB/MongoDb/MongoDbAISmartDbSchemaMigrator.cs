...
public class MongoDbAISmartDbSchemaMigrator : IAISmartDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbAISmartDbSchemaMigrator(IServiceProvider serviceProvider)
    {
